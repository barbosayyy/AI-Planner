...
namespace Generated.AI.Planner.StateRepresentation.Problem
{
    ...
    public static class TraitArrayIndex<T> where T : struct, ITrait
    {
        ...
        static TraitArrayIndex()
        {
            ...
            if (typeIndex == TypeManager.GetTypeIndex<Location>())
                ...
                Index = 1;
            else if (typeIndex == TypeManager.GetTypeIndex<Time>())
                Index = 2;
            else if (typeIndex == TypeManager.GetTypeIndex<WoodDispenser>())
                Index = 3;
            else if (typeIndex == TypeManager.GetTypeIndex<Inventory>())
                Index = 4;
        }
    }
    ...
    public struct TraitBasedObject : ITraitBasedObject, IEquatable<TraitBasedObject>
    {
        ...
        public byte WoodDispenserIndex;
        ...
        static readonly int s_TimeTypeIndex = TypeManager.GetTypeIndex<Time>();
        static readonly int s_WoodDispenserTypeIndex = TypeManager.GetTypeIndex<WoodDispenser>();
        static readonly int s_InventoryTypeIndex = TypeManager.GetTypeIndex<Inventory>();
        ...
        public bool MatchesTraitFilter(NativeArray<ComponentType> componentTypes)
        {
            for (int i = 0; i < componentTypes.Length; i++)
            {
                ...
                else if (t.TypeIndex == s_TimeTypeIndex)
                {
                    if (t.AccessModeType == ComponentType.AccessMode.Exclude ^ TimeIndex == Unset)
                        return false;
                }
                else if (t.TypeIndex == s_WoodDispenserTypeIndex)
                {
                    if (t.AccessModeType == ComponentType.AccessMode.Exclude ^ WoodDispenserIndex == Unset)
                        return false;
                }
                else if (t.TypeIndex == s_InventoryTypeIndex)
                {
        ...
        public bool Equals(TraitBasedObject other)
        {
                ...
                return LocationIndex == other.LocationIndex && PlanningAgentIndex == other.PlanningAgentIndex && TimeIndex == other.TimeIndex && WoodDispenserIndex == other.WoodDispenserIndex && InventoryIndex == other.InventoryIndex;
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                    ...
                    var hashCode = LocationIndex.GetHashCode();
                     ...
                     hashCode = (hashCode * 397) ^ TimeIndex.GetHashCode();
                     hashCode = (hashCode * 397) ^ WoodDispenserIndex.GetHashCode();
                     hashCode = (hashCode * 397) ^ InventoryIndex.GetHashCode();
                return hashCode;
            }
        }
    }
    ...
    public struct StateData : ITraitBasedStateData<TraitBasedObject, StateData>
    {
        ...
        public DynamicBuffer<WoodDispenser> WoodDispenserBuffer;
        ...
        public StateData(ExclusiveEntityTransaction transaction, Entity stateEntity)
        {
            ...
            TimeBuffer = transaction.GetBuffer<Time>(stateEntity);
            WoodDispenserBuffer = transaction.GetBuffer<WoodDispenser>(stateEntity);
            InventoryBuffer = transaction.GetBuffer<Inventory>(stateEntity);
        }
        ...
        public StateData(int jobIndex, EntityCommandBuffer.ParallelWriter entityCommandBuffer, Entity stateEntity)
        {
            ...
            WoodDispenserBuffer = entityCommandBuffer.AddBuffer<WoodDispenser>(jobIndex, stateEntity);
        ...
        public StateData Copy(int jobIndex, EntityCommandBuffer.ParallelWriter entityCommandBuffer)
        {
            ...
            var WoodDispensers = entityCommandBuffer.SetBuffer<WoodDispenser>(jobIndex, stateEntity);
            WoodDispensers.CopyFrom(WoodDispenserBuffer.AsNativeArray());
            ...
            return new StateData
            {
                ...
                TimeBuffer = Times,
                WoodDispenserBuffer = WoodDispensers,
        ...
        public void AddObject(NativeArray<ComponentType> types, out TraitBasedObject traitBasedObject, TraitBasedObjectId objectId, FixedString64 name = default)
        {
            ...
            for (int i = 0; i < types.Length; i++)
            {
                ...
                else if (t.TypeIndex == s_TimeTypeIndex)
                {
                    ...
                    traitBasedObject.TimeIndex = (byte) (TimeBuffer.Length - 1);
                }
                else if (t.TypeIndex == s_WoodDispenserTypeIndex)
                {
                    WoodDispenserBuffer.Add(default);
                    traitBasedObject.WoodDispenserIndex = (byte) (WoodDispenserBuffer.Length - 1);
                }
                else if (t.TypeIndex == s_InventoryTypeIndex)
                {
                    InventoryBuffer.Add(default);
                    traitBasedObject.InventoryIndex = (byte) (InventoryBuffer.Length - 1);
                }
            }
            ...
            ref TraitBasedObject traitBasedObject)
        {
            unsafe
            {
                foreach (var type in sourceTraitTypes)
                {
                    ...
                    if (type == typeof(Generated.Semantic.Traits.TimeData))
                    {
                        var traitData = sourceEntityManager.GetComponentData<Generated.Semantic.Traits.TimeData>(sourceEntity);
                        var plannerTraitData = new Time();
                        UnsafeUtility.CopyStructureToPtr(ref traitData, UnsafeUtility.AddressOf(ref plannerTraitData));
                        SetTraitOnObject(plannerTraitData, ref traitBasedObject);
                    }
                    if (type == typeof(Generated.Semantic.Traits.WoodDispenserData))
                    {
                        var traitData = sourceEntityManager.GetComponentData<Generated.Semantic.Traits.WoodDispenserData>(sourceEntity);
                        var plannerTraitData = new WoodDispenser();
                        UnsafeUtility.CopyStructureToPtr(ref traitData, UnsafeUtility.AddressOf(ref plannerTraitData));
                        SetTraitOnObject(plannerTraitData, ref traitBasedObject);
                    }
                    if (type == typeof(Generated.Semantic.Traits.InventoryData))
                    {
                        var traitData = sourceEntityManager.GetComponentData<Generated.Semantic.Traits.InventoryData>(sourceEntity);
                        var plannerTraitData = new Inventory();
                        UnsafeUtility.CopyStructureToPtr(ref traitData, UnsafeUtility.AddressOf(ref plannerTraitData));
                        SetTraitOnObject(plannerTraitData, ref traitBasedObject);
                    }
                }
        ...
        public void SetTraitOnObject(ITrait trait, ref TraitBasedObject traitBasedObject)
        {
            if (trait is Location LocationTrait)
                ...
                SetTraitOnObject(TimeTrait, ref traitBasedObject);
            else if (trait is WoodDispenser WoodDispenserTrait)
                SetTraitOnObject(WoodDispenserTrait, ref traitBasedObject);
            else if (trait is Inventory InventoryTrait)
                SetTraitOnObject(InventoryTrait, ref traitBasedObject);
            else 
        ...
        public void SetTraitOnObjectAtIndex(ITrait trait, int traitBasedObjectIndex)
        {
            if (trait is Location LocationTrait)
                ...
                SetTraitOnObjectAtIndex(TimeTrait, traitBasedObjectIndex);
            else if (trait is WoodDispenser WoodDispenserTrait)
                SetTraitOnObjectAtIndex(WoodDispenserTrait, traitBasedObjectIndex);
            else if (trait is Inventory InventoryTrait)
                SetTraitOnObjectAtIndex(InventoryTrait, traitBasedObjectIndex);
            else 
                throw new ArgumentException($"Trait {trait} of type {trait.GetType()} is not supported in this state representation.");
        }
        ...
        public bool RemoveObject(TraitBasedObject traitBasedObject)
        {
            ...
            RemoveTraitOnObject<Time>(ref traitBasedObject);
            RemoveTraitOnObject<WoodDispenser>(ref traitBasedObject);
            RemoveTraitOnObject<Inventory>(ref traitBasedObject);
        ...
        public bool RemoveTraitBasedObjectAtIndex(int traitBasedObjectIndex)
        {
            ...
            RemoveTraitOnObjectAtIndex<Time>(traitBasedObjectIndex);
            RemoveTraitOnObjectAtIndex<WoodDispenser>(traitBasedObjectIndex);
            RemoveTraitOnObjectAtIndex<Inventory>(traitBasedObjectIndex);
        ...
        DynamicBuffer<T> GetBuffer<T>() where T : struct, ITrait
        {
            ...
            switch (index)
            {
                ...
                case 3:
                    return WoodDispenserBuffer.Reinterpret<T>();
                case 4:
        ...
        public bool Equals(StateData rhsState)
        {
            ...
            if (TraitBasedObjects.Length != rhsState.TraitBasedObjects.Length
                ...
                || TimeBuffer.Length != rhsState.TimeBuffer.Length
                || WoodDispenserBuffer.Length != rhsState.WoodDispenserBuffer.Length
                || InventoryBuffer.Length != rhsState.InventoryBuffer.Length)
                return false;
        ...
        bool ObjectsMatchAttributes(TraitBasedObject traitBasedObjectLHS, TraitBasedObject traitBasedObjectRHS, StateData rhsState)
        {
            ...
            if (traitBasedObjectLHS.TimeIndex != TraitBasedObject.Unset
                && !TimeTraitAttributesEqual(TimeBuffer[traitBasedObjectLHS.TimeIndex], rhsState.TimeBuffer[traitBasedObjectRHS.TimeIndex]))
                return false;


            if (traitBasedObjectLHS.WoodDispenserIndex != TraitBasedObject.Unset
                && !WoodDispenserTraitAttributesEqual(WoodDispenserBuffer[traitBasedObjectLHS.WoodDispenserIndex], rhsState.WoodDispenserBuffer[traitBasedObjectRHS.WoodDispenserIndex]))
                return false;


            if (traitBasedObjectLHS.InventoryIndex != TraitBasedObject.Unset
                && !InventoryTraitAttributesEqual(InventoryBuffer[traitBasedObjectLHS.InventoryIndex], rhsState.InventoryBuffer[traitBasedObjectRHS.InventoryIndex]))
                return false;
        ...
        bool TimeTraitAttributesEqual(Time one, Time two)
        {
            return
                    one.Value == two.Value;
        }
        
        bool WoodDispenserTraitAttributesEqual(WoodDispenser one, WoodDispenser two)
        {
            return
                    one.DispenseWood == two.DispenseWood;
        }
        
        bool InventoryTraitAttributesEqual(Inventory one, Inventory two)
        {
            return
                    one.NewProperty == two.NewProperty && 
        ...
        public override int GetHashCode()
        {
            ...
            bufferLength = TimeBuffer.Length;
            for (int i = 0; i < bufferLength; i++)
            {
                var element = TimeBuffer[i];
                var value = 397
                    ^ element.Value.GetHashCode();
                stateHashValue = 3860031 + (stateHashValue + value) * 2779 + (stateHashValue * value * 2);
            }
            bufferLength = WoodDispenserBuffer.Length;
            for (int i = 0; i < bufferLength; i++)
            {
                var element = WoodDispenserBuffer[i];
                var value = 397
                    ^ (int) element.DispenseWood;
                stateHashValue = 3860031 + (stateHashValue + value) * 2779 + (stateHashValue * value * 2);
            }
            bufferLength = InventoryBuffer.Length;
            for (int i = 0; i < bufferLength; i++)
            {
                var element = InventoryBuffer[i];
                var value = 397
                    ^ (int) element.NewProperty
        ...
        public override string ToString()
        {
            ...
            for (var traitBasedObjectIndex = 0; traitBasedObjectIndex < numObjects; traitBasedObjectIndex++)
            {
                ...
                traitIndex = traitBasedObject[i++];
                if (traitIndex != TraitBasedObject.Unset)
                    sb.AppendLine(WoodDispenserBuffer[traitIndex].ToString());
    ...
    public struct StateDataContext : ITraitBasedStateDataContext<TraitBasedObject, StateEntityKey, StateData>
    {
        ...
        [ReadOnly,NativeDisableContainerSafetyRestriction] public BufferFromEntity<Time> TimeData;
        [ReadOnly,NativeDisableContainerSafetyRestriction] public BufferFromEntity<WoodDispenser> WoodDispenserData;
        [ReadOnly,NativeDisableContainerSafetyRestriction] public BufferFromEntity<Inventory> InventoryData;
        ...
        public StateDataContext(SystemBase system, EntityArchetype stateArchetype)
        {
            ...
            WoodDispenserData = system.GetBufferFromEntity<WoodDispenser>(true);
        ...
        public StateData GetStateData(StateEntityKey stateKey)
        {
            ...
            return new StateData
            {
                ...
                WoodDispenserBuffer = WoodDispenserData[stateEntity],
